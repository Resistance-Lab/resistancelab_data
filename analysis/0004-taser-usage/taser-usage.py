...
april_2018_march_2019 = pd.read_csv(os.path.join(repo_root, 'cleaned_data', 'use-of-force', 'by-ced-type-force-region', 'april2018-march2019.csv'))
april_2018_march_2019['ytd'] = '2019-03-31'
april_2018_march_2019.drop(["Region"], axis=1, inplace=True)

april_2017_march_2018 = pd.read_csv(os.path.join(repo_root, 'cleaned_data', 'use-of-force', 'by-ced-type-force-region', 'april2017-march2018.csv'))
april_2017_march_2018['ytd'] = '2018-03-31'
april_2017_march_2018.drop(["Region"], axis=1, inplace=True)

january_december_2016_revised = pd.read_csv(os.path.join(repo_root, 'cleaned_data', 'use-of-force', 'by-ced-type-force-region', 'january-december2016-revised.csv'))
...
january_december2015_revised = pd.read_csv(os.path.join(repo_root, 'cleaned_data', 'taser-use', 'by-ced-type-force-region', '2015-revised.csv'))
january_december2015_revised['ytd'] = '2015-12-31'
january_december2015_revised.drop(["Proportion of TASER ® X26 use - discharge", "Proportion of TASER ® X26 use - non-discharge"], axis=1, inplace=True)
