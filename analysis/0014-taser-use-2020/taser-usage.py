...
april_1019_march_2020 = pd.read_csv(
    os.path.join(repo_root, 'cleaned_data', 'use-of-force', 'by-ced-type-force-region', 'april2019-march2020.csv'))
april_1019_march_2020['ytd'] = '2020-03-31'
april_1019_march_2020.drop(["Region"], axis=1, inplace=True)
...
# Concat all the data
dataframes = [april_1019_march_2020, april_2018_march_2019, april_2017_march_2018, january_december_2016_revised, january_december2015_revised]
