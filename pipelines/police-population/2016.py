...
ods_file = download("https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/585709/police-workforce-tables-sep16.ods")
...
officer_fte['Force/Region'] = officer_fte['Force/Region'].str.replace('Wiltshire1', 'Wiltshire')
officer_fte['Force/Region'] = officer_fte['Force/Region'].str.strip()
officer_fte.to_csv(os.path.join(fte_output, "2016.csv"), index=False)
